...
def _get_openai_client():
    ...
    """
    api_key = "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"
    if not api_key:
        return None, None
    try:
